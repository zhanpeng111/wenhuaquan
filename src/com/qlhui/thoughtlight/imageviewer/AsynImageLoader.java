...
public class AsynImageLoader {
	 ...
	 */
	public void showImageAsyn(ImageView imageView, int width,int height,String url, int resId){
		...
		public void run() {
			while(isRunning){
				...
				while(taskQueue.size() > 0){
					...
					// 将下载的图片添加到缓存
					task.bitmap = PicUtil.getbitmap(task.path,window_width,window_height);
