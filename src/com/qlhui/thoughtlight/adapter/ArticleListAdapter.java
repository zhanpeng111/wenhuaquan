...
public class ArticleListAdapter extends MybaseAdapter {
	...
	public ArticleListAdapter(Context ctx, List<AshamedInfo> list) {
		this.list = list;
		this.ctx = ctx;
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		String label = list.get(arg0).getLabel();
		hold.Blabel = (TextView) arg1.findViewById(R.id.label_bid);
		hold.Rlabel = (TextView) arg1.findViewById(R.id.label_rid);
	/*
		if(!label.equalsIgnoreCase(""))
		{
			...
			hold.Blabel.setText(temp[0]);
			
	
			hold.Rlabel.setText(temp[1]);
			
		}
		else
		*/
		{
			hold.Blabel.setVisibility(View.GONE);
			hold.Rlabel.setVisibility(View.GONE);
		}
