...
import com.qlhui.suishouji.MainActivity;
import com.qlhui.suishouji.SplashScreenActivity;
 ...
 * 有图有真相的fragment
 * */
public class GongguoFragment extends Fragment implements OnClickListener {
	...
	private ArticleListAdapter mAdapter = null;// ����ɾ��
	...
	private Button mGgbutton;
	/*
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		view = LayoutInflater.from(getActivity()).inflate(R.layout.frame_picture, container, false);
	...
	*/
	...
	//	view = inflater.inflate(R.layout.frame_picture, container, false);
	...
	private void initView() {
		...
		mGgbutton = (Button)view.findViewById(R.id.ggbtn);
		mGgbutton.setOnClickListener(new OnClickListener(){  
	        @Override  
	...
	{
		super.onResume();
		ctx.setActionStyle("人生记账本",false);
	}
